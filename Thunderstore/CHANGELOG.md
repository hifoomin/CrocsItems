...
- Fixed Shrine of Crocs not dropping items sometimes
- Fixed Crocs Sandals healing radius not scaling with body radius
- Fixed Crocs Echo Wave not removing buffs when removed
- Fixed Crocs Echo Wave having uncapped Maximum Damage
- Fixed Crocs Classic not removing buffs when removed
- Fixed Squishy Glitter Star not applying Cooldown Reduction properly
